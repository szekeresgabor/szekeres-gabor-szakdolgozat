...
public static class WebApplicationBuilderExtensions
{
    public async static Task<WebApplication> BuildApi(this WebApplicationBuilder builder)
    {
        ...
        {
            options.Title = "Panaszkezelo API Dokumentáció";
            options.Version = "v1";
            ...
            options.PostProcess = apiDocument =>
            {
                ...
                var outputPath = Path.Combine(
                    ...
                    "..", "..", "..", "..", "..", "frontend", "panaszkezelo", "src", "app", "generated", "panaszkezelo-api.ts");
        ...
        builder.Services.AddDbContext<PanaszkezeloDbContext>(options =>
        {
